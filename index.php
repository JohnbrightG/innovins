...
<?php 
		...
		if (isset($_SESSION['user'])){
			...
			$redirect = $config['base_url'].'/dashboard.php';
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">log in to continue to Affiliate.</p>
                                        </div>
                                             ...
                                             <form class="form-horizontal" id="frmlogin" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="text" class="form-control pe-5 password-input" placeholder="Enter password" name="password" id="password-input">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Don't have an account ? <a href="signup.php" class="fw-bold text-primary text-decoration-underline"> Signup</a> </p>
											<p class="mb-0"><a href="forgetpassword.php" class="fw-bold text-primary text-decoration-underline"> Forget Password</a> </p>
										</div>
                                    </div>
                                </div>
                            </div>
